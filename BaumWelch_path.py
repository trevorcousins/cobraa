""""
This should be identical to /cobraa/BaumWelch.py, except uses the pathmodels matrix
"""
...
import os
import pickle
from transition_matrix_path import *
from utils import *
...
class BaumWelch:
    ...
    def Powell_parameter_search(self,A_new,iteration):
        ...
        tm_current = Transition_Matrix_path(D=self.D,spread_1=self.spread_1,spread_2=self.spread_2,midpoint_transitions=self.midpoint_transitions) # initialise transition matrix object
        if self.T_S_index is None: # panmixia
